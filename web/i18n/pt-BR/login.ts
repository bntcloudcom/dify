const translation = {
  ...
  welcome: 'Bem-vindo à Soph-IA, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária da Soph-IA, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe na Soph-IA',
  invalid: 'O link expirou',
  explore: 'Explorar a Soph-IA',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever na Soph-IA e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença da Soph-IA Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando a Soph-IA.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Soph-IA. Entre em contato com o administrador para continuar usando a Soph-IA.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença da Soph-IA Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando a Soph-IA.',
}
