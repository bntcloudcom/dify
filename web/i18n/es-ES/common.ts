const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta Soph-IA',
    langGeniusAccountTip: 'Tu cuenta Soph-IA y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en Soph-IA para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por Soph-IA te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de Soph-IA.',
    link: 'Aprende cómo desarrollar tu propia Extensión API.',
    linkUrl: 'https://docs.soph-ia.app/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Soph-IA {{version}} ya está disponible.',
    latestAvailable: 'Soph-IA {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
