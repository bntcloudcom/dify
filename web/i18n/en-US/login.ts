const translation = {
  ...
  welcome: '👋 Welcome to Soph-IA, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Soph-IA Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Soph-IA',
  invalid: 'The link has expired',
  explore: 'Explore Soph-IA',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Soph-IA and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Soph-IA Enterprise license for your workspace has expired. Please contact your administrator to continue using Soph-IA.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Soph-IA license server. Please contact your administrator to continue using Soph-IA.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Soph-IA Enterprise license for your workspace is inactive. Please contact your administrator to continue using Soph-IA.',
}
